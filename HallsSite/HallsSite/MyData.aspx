<%@ Page Title="" Language="C#" MasterPageFile="~/User.Master" AutoEventWireup="true" CodeBehind="MyData.aspx.cs" Inherits="HallsSite.MyData" %>
    ...
    <div class="panel-body">
     ...
     <div class="form-group">
          ...
          <div class="form-group">
                  ...
                  <asp:Button ID="Order" CssClass="btn btn-primary" runat="server" Text="Мои бронирование" onclick="MyOrder_Click" />
                  </div>
