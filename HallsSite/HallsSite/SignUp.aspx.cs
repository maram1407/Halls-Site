    ...
    public partial class SignUp : System.Web.UI.Page
    {
        ...
        protected void txtsignup_Click(object sender, EventArgs e)
        {
            ...
            else
            {
                ...
                MessageBox.Show(this, "Регистрация не удалась");
        ...
        private bool isformvalid()
        {
            ...
            {
                Response.Write("<script> alert(' Имя недействителен');  </script>");
                txtName.Focus();
                return false;
            }
            else if (txtEmail.Text == "")
            {
                Response.Write("<script> alert(' Email недействительно');  </script>");
                txtEmail.Focus();
                return false;
            }
